...
export default function Login() {
  return (
     <div className="h-160 flex justify-center items-center w-full">
      <form method="POST" action="#">
        <div className="bg-white px-10 py-8 rounded-xl w-screen shadow-xl max-w-sm">
          <div className="space-y-4">
            <h1 className="text-center text-3xl font-semibold text-gray-600">Login</h1>
            <hr />
            {/* Email input */}
          ...
          <div className="flex justify-center items-center mt-4">
            <label className="inline-flex items-center text-gray-700 font-medium text-xs text-center">
              <input
                type="checkbox"
